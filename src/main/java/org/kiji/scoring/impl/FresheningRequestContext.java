...
final class FresheningRequestContext {
  ...
  /** CounterManager in which to store counters for this Freshening request. */
  ...
  /**
   * Get the CounterManager for this request.
   *
   * @return the CounterManager for this request.
   */
